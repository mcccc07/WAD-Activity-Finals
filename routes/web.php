...
Route::middleware('auth')->group(function () {
    Route::get('/dashboard', function () {
        ...
        if ($user->role === 'seller' || $user->role === 'user') { // Allow both to see dashboard
    ...
    Route::middleware(AdminMiddleware::class)->group(function () {
        ...
        Route::patch('/admin/seller/{seller}/approve', [SellerController::class, 'approve'])->name('seller.approve');
