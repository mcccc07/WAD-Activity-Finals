...
export default function AuthenticatedLayout({ header, children }) {
    ...
    const icons = {
        ...
        orders: (
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M18 4v16a2 2 0 01-2 2H10L5 17V4a2 2 0 012-2h9a2 2 0 012 2z" />
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 17h5v5" />
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2.5} d="M9 8h.01M9 12h.01M9 16h.01" />
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8h3M12 12h3M12 16h3" />
            </svg>
        )
    };
                ...
                <nav className="flex-1 space-y-2 px-3 py-6">
                    ...
                    {user.role === 'seller' && (
                        <>
                            ...
                            <NavItem href={route('seller.products.index')} active={route().current('seller.products.*')} icon={icons.products} collapsed={collapsed}>
                                My Products
                            </NavItem>
                        </>
                    )}
                    {user.role === 'user' && (
                        <>
                            ...
                            <NavItem href={route('orders.index')} active={route().current('orders.*')} icon={icons.orders} collapsed={collapsed} badge={unnotifiedOrdersCount}>
                                My Orders
                            </NavItem>
                            <Link
